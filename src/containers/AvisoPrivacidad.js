...
const AvisoPrivacidad = React.memo(() => {
    ...
    return (
        <Container id="aviso-privacidad" className="mt-5">
                ...
                <Col md={10}>
                    <Card className="shadow-lg p-4 bg-body-tertiary rounded">
                        <Card.Body>
                            ...
                            <div className="text-center mt-5">
                                <Button variant="primary" className="no-print" onClick={handleAceptarContinuar}>
...
export default withAuth(AvisoPrivacidad);
